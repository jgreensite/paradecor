                        ...
                        <div className="grid grid-cols-3 gap-2">
                          {['x', 'y', 'z'].map((axis) => (
                            <div key={axis} className="flex flex-col">
                              ...
                              <input 
                                type="number" 
                                value={previewTransform[group as 'rotation'|'position'][axis as 'x'|'y'|'z']}
                                onChange={(e) => setPreviewTransform(prev => ({
                                  ...prev, 
                                  [group]: { ...prev[group as 'rotation'|'position'], [axis]: parseFloat(e.target.value) || 0 }
                                }))}
